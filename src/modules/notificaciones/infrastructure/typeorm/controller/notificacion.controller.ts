...
import { DispositivoDto } from 'src/modules/notificaciones/application/dto/Dispositivo.dto';
...
export class NotificacionController {
  constructor(private readonly pushNotificationService: NotificacionService) {}
  ...
  async guardarDispositivo(@Body() request: DispositivoDto) {
    return await this.pushNotificationService.guardarDispositivo(
      request.id_paciente,
      request.token,
    );
  }
