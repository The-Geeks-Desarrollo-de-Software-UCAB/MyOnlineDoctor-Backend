...
import { PacienteEntity } from 'src/modules/paciente/domain/entities/paciente.entity';
import { IdPaciente } from 'src/modules/paciente/domain/value-objects/idPaciente.value-object';

@EntityRepository(Paciente)
export class OrmRepoPaciente extends Repository<Paciente> implements IRepoPaciente {
